...
CREATE TABLE `questions` (
  ...
  `libelle_question` varchar(216) DEFAULT NULL,
  `id_theme` int(1) DEFAULT NULL,
  `difficulte_question` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `reponses` (
  ...
  `libelle_reponse` varchar(100) DEFAULT NULL,
  `valeur_reponse` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
